...
- [EY OpsChain](https://www.ey.com/en_us/services/blockchain/platforms/opschain-traceability) - EY’s enterprise blockchain platform for supply chain, procurement, and financial operations
- [Baseline protocol](https://www.baseline-protocol.org/) - Open-source standard for enterprise blockchain applications using verified state synchronization and multiparty coordination
- [Hats Protocol](https://www.hatsprotocol.xyz/) - Roles and permissions management
- [EthSign](https://sign.global/ethsign) - E-signatures linked directly to onchain actions
- [CamoSign](https://camotext.ai/blogposts/introduction-to-camosign) - Private by design e-signature app with zero uploads of documents or signatory info, using Ethereum for timestamps
